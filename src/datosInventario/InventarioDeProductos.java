...
abstract class InventarioDeProductos implements Serializable {
    ...
    public String toString() {
        return "Nombre: " + getNombre() + ", Cantidad: " + getCantidadDeProducto() + ", Código: " + getCodigo() +
                ", Marca: " + getMarca() + ", Descripción: " + getDescripcion() + ", Fecha de vencimiento: " + getFechaDeVencimiento();
    }
}